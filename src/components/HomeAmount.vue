...
import { formatExactCurrency, formatHomeAmountParts } from '../lib/format';
...
const exactAmount = computed(() => formatExactCurrency(props.amount, network.currency));
</script>

<template>
  <span v-tooltip="`${exactAmount} ${network.currency.symbol}`" class="home-amount">
