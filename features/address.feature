Feature: Address page
  ...
  Scenario: should link recipient delegate name to delegate page
    Given I'm on page "/address/16313739661670634666L"
  ...
  Scenario: should link votes to delegate page
    Given I'm on page "/address/16313739661670634666L"
    When I click "show votes button"
    And I click "vote link" no. 1
    Then I should be on page "/delegate/2581762640681118072L"
