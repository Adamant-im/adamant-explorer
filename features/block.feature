Feature: Block page
  Scenario: should show title, summary, and transactions
    ...
    And I should see table "transactions" with 50 rows starting with:
      ...
      |----------------------|---------------------------|------------|-----------------------|--------|-------|---------------|
      | 3634383815892709956  | /2016\/05\/24 \d\d:00:00/ | genesis_51 | Delegate registration | 0 LSK  | 0 LSK | Confirmed     |
      | 8038215676969674333  | /2016\/05\/24 \d\d:00:00/ | genesis_2  | Delegate registration | 0 LSK  | 0 LSK | Confirmed     |
      | 12531923965746850440 | /2016\/05\/24 \d\d:00:00/ | genesis_3  | Delegate registration | 0 LSK  | 0 LSK | Confirmed     |
      | 1513655759945413173  | /2016\/05\/24 \d\d:00:00/ | genesis_4  | Delegate registration | 0 LSK  | 0 LSK | Confirmed     |
      | 17128624452873376878 | /2016\/05\/24 \d\d:00:00/ | genesis_5  | Delegate registration | 0 LSK  | 0 LSK | Confirmed     |
