...
module.exports = function (app) {
    ...
    var processTransaction = function (tx, cb) {
        async.waterfall ([
            function (waterCb) {
                tx.usd = exchange.LISKUSD(tx.amount + tx.fee);
    ...
    var processTransactions = function (transactions, cb) {
        ...
        async.waterfall ([
            function (cb) {
                _.each (transactions, knowledge.inTx);
                cb (null, transactions);
            },
            function (result, waterCb) {
                async.eachSeries (result, function (t, cb) {
                    t.usd = exchange.LISKUSD(t.amount + t.fee);
                    getSenderDelegate (t, cb, tmpDelegateCache);
                }, function () {
                    return waterCb (null, result);
                });
            },
            function (result, waterCb) {
                async.eachSeries (result, function (t, cb) {
                    getRecipientPublicKey (t, cb, tmpDelegateCache);
                }, function () {
                    return waterCb (null, result);
                });
            },
            function (result, waterCb) {
                async.eachSeries (result, function (t, cb) {
                    getRecipientDelegate (t, cb, tmpDelegateCache);
                }, function () {
                    return waterCb (null, result);
                });
            }
